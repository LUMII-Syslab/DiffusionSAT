...
class DIMACDataset(Dataset):
    ...
    def __init__(self, data_dir, min_vars, max_vars, force_data_gen=False, max_nodes_per_batch=15000, shuffle_size=200, **kwargs) -> None:
    ...
    def write_dimacs_to_file(self, data_folder: Path, data_generator: callable):
        ...
        for idx, (n_vars, clauses) in enumerate(data_generator()):
            # TODO: Check if label is present in the generator result, else solve it
            clauses = [elements_to_str(c) for c in clauses]
            # TODO: add comment with solutions
    ...
    def prepare_example(self, batch):
        ...
        for file in batch:
            ...
            # TODO: read labels and discard all other comments
    ...
    def feature_from_file(self, data_record):
        # TODO: Read label from data_record
        features = {
